...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentsBoxServer = __webpack_require__(418);

	var _CommentsBoxServer2 = _interopRequireDefault(_CommentsBoxServer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactOnRails2.default.register({ CommentsBox: _CommentsBoxServer2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _context = __webpack_require__(414);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handleError = __webpack_require__(355);

	var _handleError2 = _interopRequireDefault(_handleError);

	var _isRouterResult = __webpack_require__(357);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _server = __webpack_require__(356);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keys = __webpack_require__(359);
	...
	var _generatorFunction = __webpack_require__(413);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(364)('keys', function($keys){
	  return function keys(it){
	    return $keys(toObject(it));
	  };
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(196).Map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY        = __webpack_require__(377)
	  ...
	  , redefine       = __webpack_require__(378)
	  , hide           = __webpack_require__(379)
	  , has            = __webpack_require__(383)
	  , Iterators      = __webpack_require__(384)
	  , $iterCreate    = __webpack_require__(385)
	  , setToStringTag = __webpack_require__(386)
	  , getProto       = __webpack_require__(380).getProto
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(379)(IteratorPrototype, __webpack_require__(387)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var def = __webpack_require__(380).setDesc
	  , has = __webpack_require__(383)
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 23.1 Map Objects
	__webpack_require__(410)('Map', function(get){
	  return function Map(){ return get(this, arguments.length > 0 ? arguments[0] : undefined); };
	}, {
	  // 23.1.3.6 Map.prototype.get(key)
	  get: function get(key){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $            = __webpack_require__(380)
	  ...
	  , step         = __webpack_require__(393)
	  , ID           = __webpack_require__(389)('id')
	  , $has         = __webpack_require__(383)
	  , isObject     = __webpack_require__(404)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof   = __webpack_require__(408)
	  , ITERATOR  = __webpack_require__(387)('iterator')
	  , Iterators = __webpack_require__(384);
	module.exports = __webpack_require__(196).getIteratorMethod = function(it){
	  if(it != undefined)return it[ITERATOR]
	    || it['@@iterator']
	    || Iterators[classof(it)];
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Map', {toJSON: __webpack_require__(412)('Map')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildConsoleReplay = __webpack_require__(416);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RenderUtils = __webpack_require__(417);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentsBox = __webpack_require__(419);
	...
	exports.default = function (props) {
	  return _react2.default.createElement(_CommentsBox2.default, props);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CommentsList = __webpack_require__(420);

	var _CommentsList2 = _interopRequireDefault(_CommentsList);

	var _Comment = __webpack_require__(421);

	var _Comment2 = _interopRequireDefault(_Comment);

	var _CommentForm = __webpack_require__(429);

	var _CommentForm2 = _interopRequireDefault(_CommentForm);

	var _LoginForm = __webpack_require__(430);

	var _LoginForm2 = _interopRequireDefault(_LoginForm);

	var _fetch_helpers = __webpack_require__(431);
	...
	var CommentsBox = function (_React$Component) {
	  ...
	  function CommentsBox(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CommentsBox).call(this, props));
	  ...
	  _createClass(CommentsBox, [{
	    ...
	    key: 'loginSubmit',
	    value: function loginSubmit(email, pwd, csrf_token) {
	      ...
	      (0, _fetch_helpers.post)('/users/login', payload, { headers: {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_CommentForm2.default, { user: user, onComment: this.commentSubmit }),
	        _react2.default.createElement(_LoginForm2.default, { user: user, onLogin: this.loginSubmit })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactCSSTransitionGroup = __webpack_require__(422);
	...
	var CommentsList = function (_React$Component) {
	  ...
	  function CommentsList(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommentsList).call(this, props));
	  }
	  ...
	  _createClass(CommentsList, [{
	    ...
	    value: function render() {
	      ...
	      var CSSTransitionGroup = __webpack_require__(428);
	      return _react2.default.createElement(
	        'div',
	        { className: 'comments-list' },
	        _react2.default.createElement(
	          _ReactCSSTransitionGroup2.default,
	          { transitionName: 'comment', transitionEnterTimeout: 1000, transitionLeaveTimeout: 300 },
	          renderComments
	        )
	      );
	    }
...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Comment, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(CommentBody, { comment: this.props.comment }),
	        _react2.default.createElement(CommentByline, { comment: this.props.comment })
	      );
	    }
	  }]);
	...
	var CommentBody = function (_React$Component2) {
	  _inherits(CommentBody, _React$Component2);

	  function CommentBody() {
	    _classCallCheck(this, CommentBody);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommentBody).apply(this, arguments));
	  }
	  ...
	  _createClass(CommentBody, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement("span", { dangerouslySetInnerHTML: { __html: this.props.comment.body } })
	      );
	    }
	  }]);
	...
	var CommentByline = function (_React$Component3) {
	  _inherits(CommentByline, _React$Component3);

	  function CommentByline() {
	    _classCallCheck(this, CommentByline);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(CommentByline).apply(this, arguments));
	  }

	  _createClass(CommentByline, [{
	    key: "render",
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "comment-byline" },
	        "By ",
	        _react2.default.createElement(
	          "a",
	          { href: this.props.comment.commenter_url },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(344);

	var assign = __webpack_require__(233);

	var ReactTransitionGroup = __webpack_require__(423);
	var ReactCSSTransitionGroupChild = __webpack_require__(425);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(344);
	var ReactTransitionChildMapping = __webpack_require__(424);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(426);
	var ReactTransitionEvents = __webpack_require__(427);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentForm = function (_React$Component) {
	  ...
	  _createClass(CommentForm, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var commentForm = this.props.user ? _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(
	          'h4',
	        ...
	        _react2.default.createElement('textarea', { className: 'form-control', rows: '10', ref: 'description' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginForm = function (_React$Component) {
	  ...
	  _createClass(LoginForm, [{
	    ...
	    key: "render",
	    value: function render() {
	      var loginForm = !this.props.user ? _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement("input", { type: "email", className: "form-control", ref: "email" }),
	        _react2.default.createElement("br", null),
	        _react2.default.createElement("input", { type: "password", className: "form-control", ref: "pwd" }),
	        _react2.default.createElement(
	          "button",
	          { className: "btn btn-primary pull-right", onClick: this.handleSubmit },
	          "Submit"
